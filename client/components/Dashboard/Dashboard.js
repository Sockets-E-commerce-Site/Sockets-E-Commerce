        ...
        <div className="flex  flex-col ">
          <div className="w-64 bg-indigo-900 h-screen bg-white">
            <nav className="mt-10">
              ...
              {/* <a className="flex items-center mt-5 py-2 px-8 block text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700" href="#">
